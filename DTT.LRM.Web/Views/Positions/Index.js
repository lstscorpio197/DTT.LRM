let _positionService = abp.services.app.position;
...
$(document).ready(function () {
    $('#myTable').DataTable({
        ...
        ajax: {
            url: abp.toAbsAppPath('Positions/GetDataTable'),
            type: 'post',
            data: function (data) {
    ...
    $(document).on('click', '#myTable tbody tr td:not(.btn-checkbox)', function () {
        ...
        window.location = abp.toAbsAppPath('Positions/CreateOrUpdate?positionId=' + id);
    })
});
